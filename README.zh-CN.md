...
| 文件 | 适用场景 | 下载 |
| --- | --- | --- |
| NSIS 安装程序 | 常规安装，推荐使用 | [AilliveMail_1.0.0_x64-setup.exe](https://github.com/amine123max/MailManager/releases/download/v1.0.0/AilliveMail_1.0.0_x64-setup.exe) |
| MSI 安装程序 | Windows 管理部署 | [AilliveMail_1.0.0_x64_zh-CN.msi](https://github.com/amine123max/MailManager/releases/download/v1.0.0/AilliveMail_1.0.0_x64_zh-CN.msi) |
| 便携版 | 无需安装直接运行 | [AilliveMail.exe](https://github.com/amine123max/MailManager/releases/download/v1.0.0/AilliveMail.exe) |
